...
bool _search_dir_entry(struct inode_info *m_inode, const char *name, struct fext_dirent *dir_e);

bool search_dir_by_ino(struct inode_info *m_inode, uint32_t i_no, struct fext_dirent *dir_e);
